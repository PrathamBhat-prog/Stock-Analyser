...
Write-Host ""
Write-Host "  For full 10-year production training run:" -ForegroundColor White
...
Write-Host ""
Write-Host "  Launch Gradio UI:" -ForegroundColor White
Write-Host "    python -m src.ui.gradio_app" -ForegroundColor Cyan
Write-Host "    then open http://localhost:7860" -ForegroundColor DarkGray
Write-Host "=========================================================" -ForegroundColor Green
Write-Host ""
